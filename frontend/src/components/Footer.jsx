...
function Footer() {
  return (
    <>
      <footer className="bg-[#282261] mt-12 w-full max-w-[1720px]  rounded-3xl">
        <div className="mx-auto max-w-screen-2xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex ml-0 md:ml-10 flex-col items-center text-center sm:items-start sm:text-left">
              ...
              <p className="text-xl mt-4 max-w-xs text-white  font-bold">
                info@swasthya.com
              </p>
            </div>

            <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:col-span-2 text-white lg:grid-cols-4">
              <div>
                <p className="font-bold text-xl text-white">Services</p>

                <ul className="mt-6 space-y-4 text-lg font-normal">
                  <li>
              ...
              <div>
                <p className="font-bold text-xl ">Helpful Links</p>
              ...
              <div>
                <p className="font-bold text-xl ">Social Link</p>
